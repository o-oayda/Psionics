...
the power fails but no psi dice cost is expended.
...
No Speech requirement will be listed in the power's description;
the manifester need not be able to be speak,
nor need the target(s) to hear and understand them.
The manifestation of the power also
does not produce a physical sound.
