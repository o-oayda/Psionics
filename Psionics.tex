...
the manifester must be able to speak to manifest the power.
In addition, the power's manifestation is distinctly audible.
It can be heard 2d6 times 10 feet away
(roll when the power is manifested)
with normal levels of background noise,
...
Thus,
powers reliant on one's inner Voice do not require speech,
nor do they produce a physical sound.
