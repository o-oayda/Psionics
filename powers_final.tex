...
save DC increases by 1 and the bonus on social skill checks
increases by 1.
}
\DndPowerHeader%
...
target. Any additional target canot be more than 15 feet
...
can modify the wind speed by an additional 10 miles per
hour, to a maximum change in wind speed of 50 knots.
}
\DndPowerHeader%
...
and any damage from impact with an object.
}
\DndPowerHeader%
...
\augment{If you spend 6 psi dice you spend, you can manifest
...
\augment{If you spend 4 additional psi dice, any movement with
...
have gained from a variant increaes by 1 to a maximum of 4.
}
\DndPowerHeader%
