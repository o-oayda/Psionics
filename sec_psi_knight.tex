...
When you reach 3rd level,
you designate a weapon currently in your possession as your \define{Soulweapon}\index{Soulweapon}.
...
Starting at 3rd level,
you gain access to a single combat \define{Form}\index{Form}.
A Form is a type of combat stance which grants a
\define{passive}\index{passive} and \define{finisher}\index{finisher} effect.
The passive effect is always realised
while you are \define{adopting}\index{adopting} the Form,
...
You cannot have more than one Form adopted at any given time.
% You must concentrate on the Form while you are adopting it,
% however you may freely concentrate on both a Form and any
% number of powers.
% That being said, if you fail a Constituion saving throw to maintain concentration,
% you lose concentration on both the Form and the power(s).
There are a number of ways in which you \define{release}\index{release} the Form,
whether by choice or not. These are:
\begin{itemize}
    \item By losing grip of your Soulweapon;
    \item By using the finisher effect of your current Form;
    \item By using a bonus action,
        noting that the earliest time at which you can do so
        is the end of the turn after you adopted your current Form; or,
    \item By becoming incapacitated or dying.
\end{itemize}
In any case, whenever you release a Form,
the passive and finisher effects cease.
...
Ordinarily, a Form must be released before you can adopt a new form.
However, if you have used the finisher effect,
you may immediately adopt a new Form for free after
the effects of the finisher are realised.
...
whenever you finish a long or short rest.
...
\begin{table*}[htbp]%
    \begin{DndTable}[
        ...
        Heat Haze Fury & Your weapon attacks have
                         ...
                         If you have made use of this
                         passive, the effect persists
                         until the start of your next
                         turn even if you release the
                         form before your current turn
                         ends.                          & As part of one of your attacks when you
                                                          ...
                                                          the weapon die or dice if the attack hits,
                                                          and, if the target fails a Constitution
                                                          saving throw with DC equal to your psionics
                                                          save DC, they are stunned until the start
                                                          of their next turn.
                                                          If the attack misses,
                                                          the form remains unreleased and
                                                          you may attempt the finisher again.        \\
        Wind Within    & Subtract double your proficiency
                         ...
                         you deal with an attack.       & As an action, you rapid movements create
                                                          a forceful current that forces creatures back.
        ...
        Peerless Poise & Any ranged attacks that hit
                         ...
                         However, your speed is
                         reduced to zero, and
                         any melee attack made
                         against you always hits.        & As an action, you unleash a duplicate of the
        ...
        Emotionless
        Retribution    & You cannot manifest nor
                         concentrate on powers.
                         However, whenever a creature
                         ...
                         telekinetic thrust.            & As an action, you assault a single creature
                                                          ...
                                                          within 60 ft. that you have line of effect to.
                                                          The target must make a Dexterity saving throw
                                                          against you psionics save DC,
                                                          taking $n$d8 bludgeoning damage on
